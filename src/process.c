...
pcb_t processes[PROCESS_COUNT] = {
    { 0, "Iapache", INIT_PRIORITY, PROCESS_NEW, pid0_ops, NULL },
    { 1, "Ibash", INIT_PRIORITY, PROCESS_NEW, pid1_ops, NULL },
    { 2, "Imozilla", INIT_PRIORITY, PROCESS_NEW, pid2_ops, NULL },
    { 3, "Ccpu", INIT_PRIORITY, PROCESS_NEW, pid3_ops, NULL },
    { 4, "Cgcc", INIT_PRIORITY, PROCESS_NEW, pid4_ops, NULL },
    { 5, "Cspice", INIT_PRIORITY, PROCESS_NEW, pid5_ops, NULL },
    { 6, "Cmysql", INIT_PRIORITY, PROCESS_NEW, pid6_ops, NULL },
    { 7, "Csim", INIT_PRIORITY, PROCESS_NEW, pid7_ops, NULL }
};
